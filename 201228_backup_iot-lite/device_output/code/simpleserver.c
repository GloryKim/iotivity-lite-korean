...
/*
 ...
 title of input_file   : server_lite_1593
*/
...
app_init(void)
{
  ...
  ret |= oc_add_device("/oic/d", "oic.d.light", "server_lite_1593", 
                       "ocf.2.0.5", /* icv value */
...
int init;
  ...
  PRINT("OCF Server name : \"server_lite_1593\"\n");
...
*/
  ...
  */
  ...
  PRINT("OCF server \"server_lite_1593\" running, waiting on incoming connections.\n");
